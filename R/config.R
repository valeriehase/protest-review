...
IN <- list(
  ...
  coded_full_sample_deduplicated = file.path(PATHS$IN, "full_paper_sample_coded_deduplicated.xlsx"),
  wos_abstracts = file.path(PATHS$IN, "wos_abstracts_2009_2023.xlsx"),
  wos_legacy    = file.path(
    PATHS$IN,
    c(
      "WoS_savedrecs_1-1000.xls",
      "WoS_savedrecs_1001-2000.xls",
      "WoS_savedrecs_2001-2765.xls"
    )
  )
)
